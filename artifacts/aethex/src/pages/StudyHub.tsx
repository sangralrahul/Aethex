...
function HubSearchCard({
  ...
  return (
    <div className="rounded-xl overflow-visible flex flex-col" style={{ background: "#FFFFFF", border: `1px solid #E5E1D8` }}>
      {/* Header */}
      <div className="p-5 pb-3">
        ...
        <h3 className="font-bold text-sm mb-1" style={{ color: "#0F1729" }}>{title}</h3>
      ...
      <div ref={ref} className="px-4 pb-4 relative mt-auto">
        ...
        {open && results.length > 0 && (
          <div className="absolute left-4 right-4 mt-1 rounded-xl overflow-hidden shadow-2xl z-50"
            style={{ background: "#FFFFFF", border: "1px solid #30363D", boxShadow: "0 8px 32px rgba(0,0,0,0.6)" }}>
            {results.map((r, i) => (
              <button key={i} onClick={() => handleSelect(r.href)}
                ...
                <div className="flex-1 min-w-0">
                  <div className="text-xs font-semibold truncate" style={{ color: "#0F1729" }}>{r.label}</div>
                  <div className="text-xs truncate" style={{ color: "#6B7280" }}>{r.sub}</div>
                </div>
            ...
            <div className="px-3 py-2 text-xs" style={{ color: "#6B7280", borderTop: "1px solid #E5E1D8" }}>
        ...
        {open && query.length >= 2 && results.length === 0 && (
          <div className="absolute left-4 right-4 mt-1 rounded-xl px-4 py-3 text-xs z-50"
            style={{ background: "#FFFFFF", border: "1px solid #30363D", color: "#6B7280" }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            <div>
              ...
              <h2 className="text-3xl md:text-4xl font-extrabold leading-tight" style={{ color: "#0F1729", letterSpacing: "-0.02em" }}>
          ...
          {/* Subject quick-links */}
          <div className="rounded-2xl overflow-hidden" style={{ background: "#FFFFFF", border: "1px solid #E5E1D8" }}>
            <div className="px-6 py-4 border-b flex items-center justify-between" style={{ borderColor: "#E5E1D8" }}>
              <h3 className="font-bold text-sm" style={{ color: "#0F1729" }}>Browse by Subject</h3>
            ...
            <div className="p-4 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2">
              {[
                ...
                <Link key={s.slug} href={`${BASE}/study-hub/medical-knowledge-hub/subjects/${s.slug}`}
                  ...
                  style={{ background: "#F5F3EE", color: "#C9D1D9", border: "1px solid #30363D" }}>
                  <span>{s.icon}</span>
                  <span>{s.name}</span>
                </Link>
              ))}
